...
public class WhittakerGeneralized8 extends WhittakerRootFindingMethod {
    ...
    public void function(Complex[] complex) {
        ...
        Complex ddfz = complex[0].sixth().times_mutable(56).plus_mutable(complex[0].square().times_mutable(180));
