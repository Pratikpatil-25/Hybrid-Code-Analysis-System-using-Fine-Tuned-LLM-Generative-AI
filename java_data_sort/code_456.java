...
public class registerdriver {
    ...
    static String Encrypt(String Password) throws CsvValidationException, IOException, NoSuchAlgorithmException {
        ...
        CSVReader reader = new CSVReader(new FileReader("back\\salt&private.csv"));
        String[] nextLine;
    ...
    public Document addDriver(String Name, String UserName, String PhoneNo, String VehicleNo, String Password)
            throws CsvValidationException, NoSuchAlgorithmException, IOException {

        MongoClient mc = MongoClients.create(
                "mongodb+srv:        MongoDatabase db = mc.getDatabase("DRIVERS");         MongoCollection<Document> col = db.getCollection("DRIVER_INFO");         FindIterable<Document> itr = col.find();         Iterator<Document> it = itr.iterator();
        ...
        user.append("Vehicle_Number", VehicleNo);
    ...
    public static void main(String[] args) throws CsvValidationException, NoSuchAlgorithmException, IOException {
        registerdriver obj = new registerdriver();
        obj.addDriver("singh", "sh1234", "89842948924", "R214349HR", "12345");
    }
